...
const FAQCard = (props) => {
    ...
    return (
        <div
            className={`mt-4 sm:mt-5 cursor-none cursor-hover overflow-hidden bg-white/5 px-4 sm:px-5 pt-4 sm:pt-5 rounded-2xl sm:rounded-3xl group ${
        ...
        >
            <h4 className="cursor-none pb-4 sm:pb-5 flex items-center justify-between text-base sm:text-lg text-gray-700 font-medium">
                <h1 
                    className={`text-white font-normal text-[15px] sm:text-[17px] pr-4 ${
