    ...
    return (
        <>
            ...
            <div className='flex fixed top-0 left-0 justify-between items-center px-5 md:px-10 w-full h-15 sm:h-20 z-100 backdrop-blur-md'>
                ...
                <div className='hidden sm:flex justify-between relative box-border px-2 py-2 rounded-4xl border bg-[#0d0d0d] border-[#1d1d1d] cursor-none'>


                    {
                        location.pathname == '/' ? <Link className='cursor-none' to='/'> <button className='cursor-hover text-[#131313] lg:text-sm px-3 lg:px-6 text-[12px] rounded-3xl py-[5px] lg:py-[10px] font-light bg-[#b5d3f5] hover:scale-90 duration-500 cursor-none' style={{ fontFamily: `"Goldman", sans-serif` }}>HOME</button></Link> : <Link className='cursor-none' to='/'> <button className='block cursor-hover relative text-white px-3 lg:px-6 lg:text-sm text-[12px] overflow-hidden rounded-3xl py-[5px] lg:py-[10px] font-light bg-transparent cursor-none hover:scale-90 duration-500 group' style={{ fontFamily: `"Goldman", sans-serif` }}><div className='block absolute h-0 w-0 top-1/2 left-1/2 rounded-full -translate-1/2 group-hover:bg-[#141414] group-hover:h-full group-hover:w-full group-hover:rounded-none duration-500 z-0 '></div> <p className='z-10 relative'>Home</p></button> </Link>
                    }

                    {
                        location.pathname.startsWith('/about') ? <Link className='cursor-none' to='/about'> <button className='cursor-hover text-[#131313] lg:text-sm px-3 lg:px-6 text-[12px] rounded-3xl py-[5px] lg:py-[10px] font-light bg-[#b5d3f5] hover:scale-90 duration-500 cursor-none' style={{ fontFamily: `"Goldman", sans-serif` }}>ABOUT</button></Link> : <Link className='cursor-none' to='/about'> <button className='block cursor-hover relative text-white px-3 lg:px-6 lg:text-sm text-[12px] overflow-hidden rounded-3xl py-[5px] lg:py-[10px] font-light bg-transparent cursor-none hover:scale-90 duration-500 group' style={{ fontFamily: `"Goldman", sans-serif` }}><div className='block absolute h-0 w-0 top-1/2 left-1/2 rounded-full -translate-1/2 group-hover:bg-[#141414] group-hover:h-full group-hover:w-full group-hover:rounded-none duration-500 z-0 '></div> <p className='z-10 relative'>About</p></button> </Link>
                    }
                    {
                        location.pathname.startsWith('/service') ? <Link className='cursor-none' to='/services'> <button className='cursor-hover text-[#131313] lg:text-sm px-3 lg:px-6 text-[12px] rounded-3xl py-[5px] lg:py-[10px] font-light bg-[#b5d3f5] hover:scale-90 duration-500 cursor-none' style={{ fontFamily: `"Goldman", sans-serif` }}>SERVICES</button></Link> : <Link className='cursor-none' to='/services'> <button className='block cursor-hover relative text-white px-3 lg:px-6 lg:text-sm text-[12px] overflow-hidden rounded-3xl py-[5px] lg:py-[10px] font-light bg-transparent cursor-none hover:scale-90 duration-500 group' style={{ fontFamily: `"Goldman", sans-serif` }}><div className='block absolute h-0 w-0 top-1/2 left-1/2 rounded-full -translate-1/2 group-hover:bg-[#141414] group-hover:h-full group-hover:w-full group-hover:rounded-none duration-500 z-0 '></div> <p className='z-10 relative'>Services</p></button> </Link>
                    }
                    {
                        location.pathname.startsWith('/project') ? <Link className='cursor-none' to='/projects'> <button className='cursor-hover text-[#131313] lg:text-sm px-3 lg:px-6 text-[12px] rounded-3xl py-[5px] lg:py-[10px] font-light bg-[#b5d3f5] hover:scale-90 duration-500 cursor-none' style={{ fontFamily: `"Goldman", sans-serif` }}>PROJECTS</button></Link> : <Link className='cursor-none' to='/projects'> <button className='block cursor-hover relative text-white px-3 lg:px-6 lg:text-sm text-[12px] overflow-hidden rounded-3xl py-[5px] lg:py-[10px] font-light bg-transparent cursor-none hover:scale-90 duration-500 group' style={{ fontFamily: `"Goldman", sans-serif` }}><div className='block absolute h-0 w-0 top-1/2 left-1/2 rounded-full -translate-1/2 group-hover:bg-[#141414] group-hover:h-full group-hover:w-full group-hover:rounded-none duration-500 z-0 '></div> <p className='z-10 relative'>Projects</p></button> </Link>
                    }
                    {
                        location.pathname.startsWith('/blog') ? <Link className='cursor-none' to='/blogs'> <button className='cursor-hover text-[#131313] lg:text-sm px-3 lg:px-6 text-[12px] rounded-3xl py-[5px] lg:py-[10px] font-light bg-[#b5d3f5] hover:scale-90 duration-500 cursor-none' style={{ fontFamily: `"Goldman", sans-serif` }}>BLOGS</button></Link> : <Link className='cursor-none' to='/blogs'> <button className='block cursor-hover relative text-white px-3 lg:px-6 lg:text-sm text-[12px] overflow-hidden rounded-3xl py-[5px] lg:py-[10px] font-light bg-transparent cursor-none hover:scale-90 duration-500 group' style={{ fontFamily: `"Goldman", sans-serif` }}><div className='block absolute h-0 w-0 top-1/2 left-1/2 rounded-full -translate-1/2 group-hover:bg-[#141414] group-hover:h-full group-hover:w-full group-hover:rounded-none duration-500 z-0 '></div> <p className='z-10 relative'>Blogs</p></button> </Link>
                    }
                    {
                        location.pathname.startsWith('/contact') ? <Link className='cursor-none' to='/contact'> <button className='cursor-hover text-[#131313] lg:text-sm px-3 lg:px-6 text-[12px] rounded-3xl py-[5px] lg:py-[10px] font-light bg-[#b5d3f5] hover:scale-90 duration-500 cursor-none' style={{ fontFamily: `"Goldman", sans-serif` }}>CONTACT</button></Link> : <Link className='cursor-none' to='/contact'> <button className='block cursor-hover relative text-white px-3 lg:px-6 lg:text-sm text-[12px] overflow-hidden rounded-3xl py-[5px] lg:py-[10px] font-light bg-transparent cursor-none hover:scale-90 duration-500 group' style={{ fontFamily: `"Goldman", sans-serif` }}><div className='block absolute h-0 w-0 top-1/2 left-1/2 rounded-full -translate-1/2 group-hover:bg-[#141414] group-hover:h-full group-hover:w-full group-hover:rounded-none duration-500 z-0 '></div> <p className='z-10 relative'>Contact</p></button> </Link>
                    }
                </div>
